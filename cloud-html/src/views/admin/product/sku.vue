...
import { productSkuCreateAdminApi, productSkuQueryAdminApi } from '@/api/product.js'
...
export default {
  ...
  methods: {
    ...
    async fetchData () {
      const resp = await productSkuQueryAdminApi(this.productId)
