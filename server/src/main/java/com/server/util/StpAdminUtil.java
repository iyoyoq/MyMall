...
/**
 * @Description: admin 多账号认证 拷贝自 StpUtil https://sa-token.cc/doc.html#/up/many-account
 * @Author: yjy
 * @Date: 2024/12/19 16:01
 */
public class StpAdminUtil {
    ...
    public static final String TYPE = "admin"; // 只需更换这里即可完成多账号功能
